...
$router->post("/server/ssl/issue", [ServerController::class, "issueSsl"]);
$router->post("/server/ssl/delete", [ServerController::class, "deleteSsl"]);
$router->post("/server/ssl/force-https", [ServerController::class, "toggleForceHttps"]);
