  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="db_name_display" value="<?= htmlspecialchars($shortDbName) ?>" disabled>
      ...
      <div class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-1">
          <label class="form-label mb-0" for="db_user_display">Nombre de Usuario</label>
          <span class="text-muted small fst-italic">(El tamano maximo de caracteres es 32, incluyendo el prefijo)</span>
        </div>
        <input type="text" class="form-control" id="db_user_display" value="<?= htmlspecialchars($shortDbUser) ?>" disabled>
        <div class="text-muted small fst-italic mt-1">
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center gap-2 mb-1">
          <label class="form-label mb-0" for="db_password">Contrasena</label>
