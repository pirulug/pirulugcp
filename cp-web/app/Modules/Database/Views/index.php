        ...
        <?php else: ?>
          <?php foreach ($databases as $db): ?>
            <tr>
              ...
              <td class="text-muted small"><?= $db["created_at"] ?? "N/A" ?></td>
              <td class="text-end pe-3 text-nowrap">
                <div class="d-flex justify-content-end gap-1">
                  ...
                  <a href="/database/delete/<?= (int)$db["id"] ?>" class="btn btn-sm btn-outline-danger text-uppercase fw-bold text-nowrap" onclick="return confirm('Estas seguro de eliminar la base de datos <?= $db["db_name"] ?>? Esta accion borrara todas las tablas y datos.')" title="Eliminar Base de Datos">
