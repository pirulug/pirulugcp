...
<form action="/php/config/<?= $version ?>/save" method="POST">
  <div class="bg-body p-3 rounded mb-3">
    ...
    <!-- max_input_time -->
    <div class="mb-3">
      <label for="max_input_time" class="form-label">max_input_time</label>
    ...
    <!-- error_reporting -->
    <div class="mb-3">
      <label for="error_reporting" class="form-label">error_reporting</label>
...
<!-- ======================================================================= -->
<!-- SECCION: EDITOR AVANZADO PHP.INI -->
<!-- ======================================================================= -->
<form action="/php/config/<?= $version ?>/raw" method="POST">
  <div class="bg-body p-3 rounded mb-3">
    ...
    <div class="mb-0">
      <textarea class="form-control font-monospace bg-body-tertiary text-body p-3" id="raw_ini_content" name="raw_ini_content" rows="22" style="resize: vertical; font-size: 0.88rem; line-height: 1.5; tab-size: 4;" spellcheck="false"><?= $rawIni ?></textarea>
    </div>
  </div>
