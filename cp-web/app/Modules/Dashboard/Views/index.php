...
<!-- Tarjetas de Estadisticas (Estilo PiruAdmin sin clases prohibidas) -->
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col text-end">
                        ...
                        <h2 class="h3 fw-bold mb-0"><?= htmlspecialchars($metrics["disk"]["percent"] ?? "0%") ?></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-borderless align-middle table-sm mb-0">
                    <tbody>
                        <tr class="border-bottom">
                            ...
                            <td class="fw-semibold py-2"><?= htmlspecialchars($metrics["hostname"] ?? "servidor") ?></td>
                        </tr>
                        <tr class="border-bottom">
                            <td class="text-body-secondary py-2">Tiempo Activo:</td>
                            <td class="py-2"><?= htmlspecialchars($metrics["uptime"] ?? "N/A") ?></td>
                        </tr>
                        <tr class="border-bottom">
                            ...
                            <td class="py-2">
                                <span class="badge bg-primary-subtle text-primary border border-primary-subtle font-monospace">
                                    <?= htmlspecialchars($metrics["load"] ?? "N/A") ?>
                                </span>
                            </td>
                        </tr>
                        <tr class="border-bottom">
                        ...
                        <tr>
                            ...
                            <td class="py-2">
                                <div class="small text-muted mb-1">
                                    <?= htmlspecialchars($metrics["disk"]["used"] ?? "0") ?> usados de <?= htmlspecialchars($metrics["disk"]["total"] ?? "0") ?> (Libre: <?= htmlspecialchars($metrics["disk"]["free"] ?? "0") ?>)
                                </div>
    ...
    <div class="col-12 col-lg-6 d-flex">
        <div class="card flex-fill w-100">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="/system" class="btn btn-sm btn-outline-secondary text-uppercase fw-bold text-nowrap">Gestionar</a>
            </div>
            <div class="card-body p-0">
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center py-3">
                        ...
                        <a href="/php" class="btn btn-sm btn-outline-primary text-uppercase fw-bold text-nowrap">Ver Versiones</a>
                    </div>
                </div>
            </div>
        </div>
