        ...
        <ul class="navbar-nav navbar-align align-items-center">
            ...
            <li class="nav-item nav-item-user dropdown ms-2">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                    <div class="avatar bg-primary text-white d-flex align-items-center justify-content-center rounded-circle fw-bold me-2" style="width: 38px; height: 38px;">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="dropdown-header text-muted small">
                        Rol: <strong><?= htmlspecialchars($currentUser["role"] ?? "admin") ?></strong>
                    </div>
